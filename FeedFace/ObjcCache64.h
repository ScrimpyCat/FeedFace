 ...
 *  - Modified objc_cache so it represents one in a 64 bit process.
...
struct objc_cache64 {
    uint64_t /*uintptr_t */ mask;            /* total = mask + 1 */
    uint64_t /*uintptr_t */ occupied;        
    uint64_t /*cache_entry * */buckets/*[1]*/;
};
