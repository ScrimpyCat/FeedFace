 ...
 *  - Modified structures so they would represent those in a 32 bit process.
...
struct dyld_image_info32 {
	uint32_t /*const struct mach_header* */ imageLoadAddress;	/* base address image is mapped into */
	uint32_t /*const char* */ imageFilePath;		/* path dyld used to load the image */
	uint32_t /*uintptr_t */ imageFileModDate;	/* time_t of image file */
